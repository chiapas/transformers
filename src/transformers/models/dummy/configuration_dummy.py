...
class DummyConfig(PretrainedConfig):
    r"""
    This is the configuration class to store the configuration of a :class:`~transformers.DummyModel`. It is used to
    instantiate an Dummy model according to the specified arguments, defining the model architecture. Instantiating
    a configuration with the defaults will yield a similar configuration to that of the Dummy
    `facebook/dummy-base-960h <https://huggingface.co/facebook/dummy-base-960h>`__ architecture.
    ...
    Args:
        vocab_size (:obj:`int`, `optional`, defaults to 32):
            Vocabulary size of the Dummy model. Defines the number of different tokens that can be represented by
            the :obj:`inputs_ids` passed when calling :class:`~transformers.DummyModel` or
            :class:`~transformers.TFDummyModel`. Vocabulary size of the model. Defines the different tokens that can
            be represented by the `inputs_ids` passed to the forward method of :class:`~transformers.DummyModel`.
        ...
        ctc_loss_reduction (:obj:`str`, `optional`, defaults to :obj:`"sum"`):
            ...
            instance of :class:`~transformers.DummyForCTC`.
    ...
    Example::
        ...
        >>> from transformers import DummyModel, DummyConfig

        >>> # Initializing a Dummy facebook/dummy-base-960h style configuration
        >>> configuration = DummyConfig()

        >>> # Initializing a model from the facebook/dummy-base-960h style configuration
        >>> model = DummyModel(configuration)
