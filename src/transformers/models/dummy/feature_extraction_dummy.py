...
"""
Feature extractor class for Dummy
"""
...
class DummyFeatureExtractor(SequenceFeatureExtractor):
    r"""
    Constructs a Dummy feature extractor.
    ...
    Args:
        ...
        return_attention_mask (:obj:`bool`, `optional`, defaults to :obj:`False`):
            Whether or not :meth:`~transformers.DummyFeatureExtractor.__call__` should return :obj:`attention_mask`.
