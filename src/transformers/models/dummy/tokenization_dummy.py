...
# Dummy has no max input length
PRETRAINED_POSITIONAL_EMBEDDINGS_SIZES = {"facebook/dummy-base-960h": sys.maxsize}

DUMMY_KWARGS_DOCSTRING = r"""
...
class DummyCTCTokenizer(PreTrainedTokenizer):

    """
    Constructs a DummyCTC tokenizer.
    ...
    def _decode(
        ...
        """
        special _decode function is needed for DummyTokenizer because added tokens should be treated exactly the
...
class DummyTokenizer(PreTrainedTokenizer):
    ...
    Args:
        ...
        do_normalize (:obj:`bool`, `optional`, defaults to :obj:`False`):
            ...
            improve the performance for some models, *e.g.*, `dummy-lv60
            <https://huggingface.co/models?search=lv60>`__.
        return_attention_mask (:obj:`bool`, `optional`, defaults to :obj:`False`):
            Whether or not :meth:`~transformers.DummyTokenizer.__call__` should return :obj:`attention_mask`.

            .. note::

                Dummy models that have set ``config.feat_extract_norm == "group"``, such as `dummy-base
                <https://huggingface.co/facebook/dummy-base-960h>`__, have **not** been trained using
                ...
                For Dummy models that have set ``config.feat_extract_norm == "layer"``, such as `dummy-lv60
                <https://huggingface.co/facebook/dummy-large-960h-lv60-self>`__, :obj:`attention_mask` should be
    ...
    pretrained_vocab_files_map = {
        ...
        "tokenizer_config_file": {
            "facebook/dummy-base-960h": "https://huggingface.co/facebook/dummy-base-960h/resolve/main/tokenizer.json",
        },
    }
    ...
    @add_end_docstrings(DUMMY_KWARGS_DOCSTRING)
    def __call__(
        self,
